...
<head>
    ...
    <style>
        ...
        body {{ font-family: 'Segoe UI', -apple-system, sans-serif; font-size: 10pt; line-height: 1.6; color: #1a1a1a; margin: 0; padding: 0; }}
        h1 {{ font-size: 18pt; color: #0052cc; border-bottom: 2px solid #e2e8f0; padding-bottom: 6px; margin-top: 25px; }}
        h2 {{ font-size: 13pt; color: #2d3748; border-bottom: 1px solid #edf2f7; padding-bottom: 4px; margin-top: 20px; }}
        h3 {{ font-size: 11pt; color: #2b6cb0; margin-top: 15px; }}
        ...
        pre {{ background-color: #1a202c; color: #f7fafc; padding: 12px; border-radius: 6px; font-size: 8.5pt; white-space: pre-wrap; word-break: break-all; margin: 12px 0; page-break-inside: avoid; }}
        code {{ background-color: #edf2f7; color: #c53030; padding: 2px 5px; border-radius: 4px; font-size: 8.5pt; }}
...
<body>
    <div style="margin-bottom: 20px; border-bottom: 3px solid #0052cc; padding-bottom: 8px;">
        <div style="font-size: 20pt; font-weight: bold; color: #0052cc;">Online Judge Platform</div>
        <div style="font-size: 11pt; color: #4a5568;">Prepared By: Kuswanth Tumma</div>
    </div>
    {body_html}
</body>
</html>"""
